          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url() ?>state">State</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="card">
                ...
                <form role="form" id="quickForm" name="myForm" action="<?= base_url() ?>state-details/update/<?=base64_encode($sk_state_id)?>" method="post">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input type="text" class="form-control" value="<?=$state_name?>" name="state_name" id="state_name" required onkeypress="return AllowAlphabet(event)">
                      </div>
                    </div>
