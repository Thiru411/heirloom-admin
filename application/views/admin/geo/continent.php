          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="card">
                ...
                <form role="form" id="quickForm" name="myForm" action="<?= base_url() ?>continent-details/Add/Save" method="post">
                  <div class="card-body">
                    <div class="form-group">
                      <label>Continent Name:</label>
                      <div class="input-group">
                        <input type="text" class="form-control" name="continent_name" id="continent_name" required onkeypress="return AllowAlphabet(event)">
                      </div>
                    </div>
            ...
            <div class="col-md-6">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">View Continent</h3>
                </div>
                <div class="card-body">
