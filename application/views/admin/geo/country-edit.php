          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="card">
                ...
                <form role="form" id="quickForm" name="myForm" action="<?= base_url() ?>country-details/update/<?=base64_encode($sk_country_id)?>" method="post">
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <option value="<?=$info->sk_continent_id?>" <?php if($continent_id==$info->sk_continent_id){echo "selected";}else{echo "";}?>><?=$info->continent_name?></option>
                        <?php }}?>
                        </select>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input type="text" class="form-control" value="<?=$country_name?>" name="country_name" id="country_name" required onkeypress="return AllowAlphabet(event)">
                      </div>
                    </div>
