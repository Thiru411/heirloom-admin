          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="card">
                ...
                <form role="form" id="quickForm" name="myForm" action="<?= base_url() ?>state-details/Add/Save" method="post">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input type="text" class="form-control" name="state_name" id="state_name" required onkeypress="return AllowAlphabet(event)">
                      </div>
                    </div>
            ...
            <div class="col-md-6">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">View State</h3>
                </div>
                <div class="card-body">
