          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="card">
                ...
                <form role="form" id="quickForm" name="myForm" action="<?= base_url() ?>city-details/Add/Save" method="post">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input type="text" class="form-control" name="city_name" id="city_name" required onkeypress="return AllowAlphabet(event)">
                      </div>
                    </div>
            ...
            <div class="col-md-6">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">View City</h3>
                </div>
                <div class="card-body">
