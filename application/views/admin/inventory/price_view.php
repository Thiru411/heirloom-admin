          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="card">
                ...
                <form role="form" id="quickForm" name="myForm" action="<?= base_url()?>inventory-price-details/Add/<?=base64_encode($inventory_id)?>" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="form-group">
                      <label>Caliper/Size</label>
                      <div class="input-group">
                        <input type="text" class="form-control" name="callper" id="category_name">
                      </div>
                    </div>
                    <div class="form-group">
                      <label>Price:</label>
                      <div class="input-group">
                        <input type="text" class="form-control" name="price" id="category_name">
                      </div>
                    </div>
                    <div class="form-group">
                      <label>Quantity:</label>
                      <div class="input-group">
                        <input type="text" class="form-control" name="quantity" id="category_name">
                      </div>
                    </div>
            ...
            <div class="col-md-6">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">View Price Details</h3>
                </div>
                <div class="card-body">
