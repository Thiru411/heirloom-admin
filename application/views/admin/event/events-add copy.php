          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card">
                ...
                <form role="form" id="quickForm" name="myForm" action="<?=base_url()?>event-details/Add/Save" method="post" enctype="multipart/form-data">
          <div class="card-body">
            <div class="row">
              <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="file" class="form-control" name="event_image" id="event_image" required > 
                </div> 
                <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="form-group">                  
                <label>City:</label>
                  <select class="form-control" name="city_id" id="city_id" required  onchange="getLocation(this.value)">
                  <option value="">Select City</option>
                  </select>
                </div>           
                <div class="form-group">
                  <label>Minimum Member:</label>
                  <input type="text" class="form-control" name="minimum_member" id="minimum_member" required onkeypress="return isNumberKeyevent(event)" />
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control float-right" name="event_date" id="event_date">
                  </div>
                  <!-- /.input group -->
                </div>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="maximum_member" id="maximum_member" required onkeypress="return isNumberKeyevent(event)" />
                </div> 
                <div class="form-group">
                    <label>Event Time:</label>

                    <div class="input-group date" id="timepicker" data-target-input="nearest">
                      <input type="text" class="form-control datetimepicker-input" data-target="#timepicker" name="event_time" id="event_time"/>
