          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card">
                ...
                <form role="form" id="quickForm" name="myForm" action="<?=base_url()?>partners-details/update/<?=base64_encode($sk_partners_id)?>" method="post" enctype="multipart/form-data">
          <div class="card-body">
            <div class="row">
              <div class="col-md-4">
              <div class="form-group">
                  <label>Partner Name:</label>
                  <input type="text" class="form-control" name="partner_name"value=<?=$partner_name?> id="title" required placeholder="Event Title"> 
                </div>  
                <div class="form-group">
                  <label>Phone Number:</label>
                  <input type="number" class="form-control" name="phone_number"value=<?=$phone_number?> id="title" required placeholder="Event Title"onkeypress="return isNumberKeyevent(event)"> 
                </div>  
             <div class="form-group">
                  <label>Partner Image:</label>
                  <img src='<?=$partner_image?>'' height='100' width='100'>
                  <input type="file" class="form-control" name="partner_image" id="event_image"  >  
                </div> 
               
                <div class="form-group">
                  <label>About:</label>
                  <input type="text" class="form-control" name="about"value="<?=$about?>" id="event_image"  >  
                </div> 
              ...
              <div class="col-md-4">
                ...
                <div class="form-group">
                  <label>Website:</label>
                  <input type="text" class="form-control" name="website" value="<?=$website?>" required />
                </div>
                <div class="form-group">
                  <label>Address:</label>
                ...
                <div class="form-group">
                  <label>Services:</label>
                    <input type="text" class="form-control float-right" name="services"value="<?=$services?>">
                  </div>
                  <!-- /.input group -->
                </div>
