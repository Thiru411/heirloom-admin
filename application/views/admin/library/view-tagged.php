          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url() ?>library-view/Tagged">Tagged</a></li>
              ...
              <div class="card">
                ...
                <table id="example1" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <?php $inactivate_url=base_url()."admin/removetag/".base64_encode($sk_tag_id);?>
                        <td>  <a href=<?=$inactivate_url?>><i class='fa fa-trash'></i></a>
