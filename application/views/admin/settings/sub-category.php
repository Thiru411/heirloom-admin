          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url() ?>category-type">Sub Category</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="card">
                ...
                <form role="form" id="quickForm" name="myForm" action="<?= base_url() ?>sub-category-details/Add/Save" method="post">
                  <div class="card-body">
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input type="text" class="form-control" name="sub_category_name" id="sub_category_name" required onkeypress="return AllowAlphabet(event)">
                      </div>
                    </div>
